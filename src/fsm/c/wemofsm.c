#include <stdio.h>
#include <string.h>
#include "../../fsm/headers/edu_cmu_sei_kalki_controller_fsm_WeMoInsightStateMachine.h"

JNIEXPORT jintArray JNICALL
Java_edu_cmu_sei_kalki_controller_fsm_WeMoInsightStateMachine_generateNextState(JNIEnv *env, jobject fsmObj,
